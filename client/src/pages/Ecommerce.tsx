        ...
        <div className="relative container max-w-4xl">
          ...
          >
            <video
              controls
              preload="metadata"
              poster="https://files.manuscdn.com/user_upload_by_module/session_file/310419663026807979/JqjkZMznInvJAoug.jpg"
              className="w-full aspect-video bg-black"
            >
              <source src="https://files.manuscdn.com/user_upload_by_module/session_file/310419663026807979/cgaeGyzcQTQSlAGL.mp4" type="video/mp4" />
            </video>
          </motion.div>
        </div>
      </section>
