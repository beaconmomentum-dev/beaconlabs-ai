        ...
        <div className="hidden lg:flex items-center gap-1">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="font-mono text-xs tracking-[0.1em] uppercase px-4 py-2 text-[oklch(0.35_0.04_240)] hover:text-[oklch(0.45_0.09_185)] transition-colors duration-300 relative group"
            >
              {link.label}
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-px bg-[oklch(0.75_0.14_85)] group-hover:w-3/4 transition-all duration-300" />
            </a>
          ))}
          <a
            href="#contact"
            ...
            <div className="container py-6 flex flex-col gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  className="font-mono text-sm tracking-[0.1em] uppercase px-4 py-3 text-[oklch(0.30_0.04_240)] hover:text-[oklch(0.45_0.09_185)] hover:bg-[oklch(0.45_0.09_185/0.05)] rounded-sm transition-colors"
                >
                  {link.label}
                </a>
              ))}
